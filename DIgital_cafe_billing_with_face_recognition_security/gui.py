...
class LoginWindow(Window):
    ...
    def build_window(self):
        ...
        self.label = tk.Label(self.root, text='Enter your login',bg="red2", width=20, font=self.font)
        ...
        self.button = tk.Button(self.root, text='Login',bg="orange", font=self.font)
...
class ChatWindow(Window):
    def __init__(self, gui, font):
        super().__init__("IceCream_Intellegence_Communication", font)
        self.gui = gui
    ...
    def build_window(self):
        ...
        self.messages_list = scrolledtext.ScrolledText(frame00, wrap='word', font=self.font,fg="saddle brown",bg="powder blue",)
        self.messages_list.insert(tk.END, 'Welcome to IceCream_Intellegence_Communication\n',)
