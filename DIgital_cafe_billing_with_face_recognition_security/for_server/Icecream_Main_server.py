...
root.title("Commuinication System_Icecream")


  
#__________________________________________________Main Funtions are here_______________________________________________________________________________
def server():
     try:
...
button_activate=Button(root,text="Activate",fg="Steel Blue",bg="#030719", command=server,width=20,height=5,justify="right",borderwidth=8,font="Verdana 8 bold")
button_activate.pack(anchor=CENTER)

 
pb=ttk.Progressbar(root,orient="horizontal",length=660,mode="determinate")
pb.pack()
pb.place(rely=0.95)
root.mainloop()
